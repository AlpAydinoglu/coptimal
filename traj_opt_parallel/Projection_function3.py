...
def QP_projection(cons, cons_v, rho, G, A,B,D,d,E,c,F,H):
    #system_parameters
    n = 10
    m = 10
    k = 4
...
def Projection3_one_step(cons,delta, A,B,D,d,E,c,F,H):
    ...
    for i in range(admm_iter):
        ...
        #QP step
        z, t_diff_qp  = QP_projection(cons, cons_v, rho, G, A,B,D,d,E,c,F,H)
...
def Projection_function3(z, delta, omega, N,A,B,D,d,E,c,F,H):
    ...
    for i in range(N):
        ...
        sol_vss, time_hold = Projection3_one_step(cons, delta[TOT*i:TOT*(i+1)],A,B,D,d,E,c,F,H)

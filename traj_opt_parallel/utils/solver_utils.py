...
def lorentz_qcqp_solver():
    """Returns a differentiable solver (diffqcqp) for Lorentz-Constrained QP's.

    Diffqcqp is a custom QCQP solver for problems of the form

    min z' A z + z' b
    s.t. ||z(N + 2i : N + 2i + 1)|| < z(i)

    Returns:
        solver object
    """
    return LCQPFn2().apply
